...
export const ContactPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen py-8 sm:py-16 px-4 bg-gray-50">

      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="text-center mb-8 sm:mb-12">
          <h1 className={`text-2xl sm:text-3xl lg:text-4xl font-bold text-green-800 mb-4 ${isVisible ? 'animate-fadeInUp stagger-1' : 'opacity-0'}`}>Contact Us</h1>
          <p className={`text-sm sm:text-base text-gray-700 max-w-2xl mx-auto px-2 ${isVisible ? 'animate-fadeInUp stagger-2' : 'opacity-0'}`}>
        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 mb-6 lg:mb-8">
              ...
              <CardContent className="pt-4 sm:pt-6">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="text-base sm:text-lg font-semibold text-green-800 mb-2">Address</h3>
                    <p className="text-sm sm:text-base text-gray-700 leading-relaxed">{contactInfo.contact_address}</p>
                    <Button
                      variant="link"
                      className="text-green-700 p-0 h-auto mt-2 text-sm sm:text-base animate-pulse-custom"
                      onClick={() => {
                        window.open(
            ...
            <Card className="border-green-200 card-hover">
              <CardContent className="pt-4 sm:pt-6">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="text-base sm:text-lg font-semibold text-green-800 mb-2">Phone</h3>
                    <p className="text-sm sm:text-base text-gray-700">{contactInfo.contact_phone}</p>
            ...
            <Card className="border-green-200 card-hover">
              <CardContent className="pt-4 sm:pt-6">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="text-base sm:text-lg font-semibold text-green-800 mb-2">Email</h3>
                    <p className="text-sm sm:text-base text-gray-700 break-all">{contactInfo.contact_email}</p>
            ...
            <Card className="border-green-200 bg-green-50 card-hover">
              <CardContent className="pt-4 sm:pt-6">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="text-base sm:text-lg font-semibold text-green-800 mb-3">Office & Shrine Timings</h3>
                    <div className="space-y-2 text-gray-700 text-xs sm:text-sm">
                      <div className="flex justify-between items-start gap-2">
                        <span className="flex-shrink-0">Monday - Saturday</span>
                        <span className="text-right">{contactInfo.office_hours?.weekdays?.monday_to_saturday || '5:00 AM - 9:00 PM'}</span>
                      </div>
                      <div className="flex justify-between items-start gap-2">
                        <span className="flex-shrink-0">Sunday</span>
                        <span className="text-right">{contactInfo.office_hours?.weekdays?.sunday || '5:00 AM - 10:00 PM'}</span>
                      </div>
                      <div className="border-t border-green-200 pt-2 mt-3">
                        <p className="font-medium mb-1">Mass Timings:</p>
                        <p className="leading-relaxed">{contactInfo.mass_timings?.daily_masses?.join(', ') || '6:00 AM, 9:00 AM, 6:00 PM'} (Daily)</p>
                        {contactInfo.mass_timings?.special_occasions?.sundays && (
                          <p className="text-xs mt-1 leading-relaxed">{contactInfo.mass_timings.special_occasions.sundays}</p>
                        )}
                      </div>
                    </div>
                  </div>
          ...
          <Card className={`border-green-200 card-hover ${isVisible ? 'animate-slideInRight stagger-2' : 'opacity-0'}`}>
            <CardContent className="p-0">
              <div className="h-64 sm:h-80 lg:h-full lg:min-h-[500px] rounded-lg overflow-hidden">
                <iframe
                  src={MAP_EMBED_URL}
                  width="100%"
                  height="100%"
        ...
        <Card className={`border-green-200 mb-6 lg:mb-8 card-hover ${isVisible ? 'animate-fadeInUp stagger-1' : 'opacity-0'}`}>
          <CardContent className="pt-4 sm:pt-6">
            <h3 className="text-lg sm:text-xl font-semibold text-green-800 mb-4 sm:mb-6">How to Reach Us</h3>
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
              <div className={`${isVisible ? 'animate-scaleIn stagger-2' : 'opacity-0'}`}>
                <h4 className="text-sm sm:text-base font-medium text-green-700 mb-2">By Air</h4>
              ...
              <div className={`${isVisible ? 'animate-scaleIn stagger-3' : 'opacity-0'}`}>
                <h4 className="text-sm sm:text-base font-medium text-green-700 mb-2">By Train</h4>
                <p className="text-xs sm:text-sm text-gray-700 leading-relaxed">
              ...
              <div className={`sm:col-span-2 md:col-span-1 ${isVisible ? 'animate-scaleIn stagger-4' : 'opacity-0'}`}>
                <h4 className="text-sm sm:text-base font-medium text-green-700 mb-2">By Road</h4>
                <p className="text-xs sm:text-sm text-gray-700 leading-relaxed">
        ...
        <Card className={`border-green-200 card-hover ${isVisible ? 'animate-scaleIn stagger-2' : 'opacity-0'}`}>
          <CardContent className="pt-4 sm:pt-6">
            <h3 className="text-lg sm:text-xl font-semibold text-green-800 mb-4 sm:mb-6 text-center">Connect With Us</h3>
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6">
              <a
                href={contactInfo.social_media?.facebook || 'https://www.facebook.com/Devasahayammountshrine'}
                target="_blank"
                rel="noopener noreferrer"
                className="flex flex-row sm:flex-col items-center gap-3 sm:gap-2 p-3 sm:p-4 rounded-lg hover:bg-green-50 transition-colors group animate-float w-full sm:w-auto justify-center"
              >
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-100 rounded-full flex items-center justify-center group-hover:bg-blue-200 transition-colors flex-shrink-0">
              ...
              >
                ...
                <span className="text-sm sm:text-base text-gray-700">YouTube</span>
              </a>
              <a
              ...
              >
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-pink-100 rounded-full flex items-center justify-center group-hover:bg-pink-200 transition-colors flex-shrink-0">
