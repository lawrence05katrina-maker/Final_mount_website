      ...
      <div className="max-w-7xl mx-auto">
        ...
        <Card className={`border-green-200 card-hover ${isVisible ? 'animate-scaleIn stagger-2' : 'opacity-0'}`}>
          <CardContent className="pt-4 sm:pt-6 pb-1 sm:pb-6">
            <h3 className="text-lg sm:text-xl font-semibold text-green-800 mb-3 sm:mb-4 text-center">Connect With Us</h3>
            <div className="flex flex-row justify-center items-center gap-6 sm:gap-8">
              ...
              >
                ...
                <span className="hidden sm:block text-sm text-gray-700">Facebook</span>
              </a>
              <a
              ...
              >
                ...
                <span className="hidden sm:block text-sm text-gray-700">YouTube</span>
              </a>
              <a
              ...
              >
                ...
                <span className="hidden sm:block text-sm text-gray-700">Instagram</span>
              </a>
            </div>
          </CardContent>
        </Card>
